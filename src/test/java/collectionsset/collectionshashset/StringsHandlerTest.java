...
public class StringsHandlerTest {
    ...
    public void checkNumberOfIdenticalElementsInSets() {
        //Given
        Set<String> strings = new HashSet<>(new RandomStringGenerator().createStrings(4, 2000));
        Set<String> anotherStrings = new HashSet<>(new RandomStringGenerator().createStrings(4, 2000));
        int a = strings.size();
