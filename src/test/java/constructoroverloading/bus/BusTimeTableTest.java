...
//Nincsenek sorrendben
    ...
    public void constructorTestList() {
        ...
        assertEquals(9, timetable.getTimeTable().get(1).getHours());
    ...
    public void nextBusShouldThrowExceptionIfNone() throws IllegalStateException {
        ...
        Exception ex = assertThrows(IllegalStateException.class, () -> {
            timetable.nextBus(new SimpleTime(21, 16));
        });
    ...
    public void testFirstBus(){
        BusTimeTable timetable = new BusTimeTable(TIME_TABLE);
        // When
        assertEquals("8:15", timetable.firstBus().toString());
    }
}