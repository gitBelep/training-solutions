...
public class RobotTest {
    ...
    public void testNavigationChain() {
        ...
        robot.rotate(370).registerNavigationPoint();
        assertEquals("[distance: 5 azimut: 45, distance: 15 azimut: 30, distance: 15 azimut: 40]", robot.getNavigationList().toString());
    }
}